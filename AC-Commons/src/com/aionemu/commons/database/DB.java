 ...
 * <
 * pre>
 * DB.select(&quot;SELECT name FROM test_table WHERE id=?&quot;, new
 * ParamReadStH() {
 * <p/>
 * public void setParams(PreparedStatement stmt) throws SQLException {
 * stmt.setInt(1, 50); }
 * <p/>
 * public void handleRead(ResultSet rset) throws SQLException { while
 * (rset.next()) { // Usually here in the custom class you would set it to your
 * needed var. var = rset.getString(&quot;name&quot;); } } });
 * </pre>
 * <p/>
 * </p>
 * <hr>
 ...
 * <p/>
 * public void handleInsertUpdate(PreparedStatement stmt) { // Usually this
 * would be data from the custom class that implements IUSth String[]
 * batchTestVars = { &quot;bob&quot;, &quot;mike&quot;, &quot;joe&quot; };
 * <p/>
 ...
 * <
 * pre>
 * DB.insertUpdate(&quot;UPDATE test_table SET some_column=? WHERE
 * other_column=?&quot;, new IUStH() {
 * <p/>
 * public void handleInsertUpdate(PreparedStatement stmt) { stmt.setString(1,
 * &quot;xxx&quot;); stmt.setInt(2, 10); stmt.executeUpdate(); } });
 * <p/>
 * </pre>
 * <p/>
 * </p>
