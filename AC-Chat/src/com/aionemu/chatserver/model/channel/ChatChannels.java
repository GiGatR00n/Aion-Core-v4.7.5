...
public class ChatChannels {
    ...
    static {
		...
		addTradeChannel("trade_Arena_D_CLobby");
		...
		addTradeChannel("trade_Gab1_02");
		addTradeChannel("trade_Gab1_03");
		addTradeChannel("trade_Gab1_04");
		...
		addRegionChannel(140010000, "public_Arena_D_CLobby");
		...
		addRegionChannel(400010000, "public_Gab1_01");
		addRegionChannel(400020000, "public_GAb1_Sub");
		addRegionChannel(400030000, "public_Gab1_02");
		addRegionChannel(400040000, "public_Gab1_03");
		addRegionChannel(400050000, "public_Gab1_04");
