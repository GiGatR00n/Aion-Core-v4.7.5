<div class="note">
	<div class="note_body">
		<div class="note_title"><a href="<?php echo Yii::app()->homeUrl; ?>admin">Админцентр</a> &rarr; Настройка платежных систем</div>
		...
		<table class="table_info">
			<tr>
				<td class="bold">Настройки Robokassa:</td>
			</tr>
			<tr>
			...
			<tr>
				<td class="bold">Настройки Interkassa:</td>
			</tr>
			<tr>
			...
			<tr class="center">
				<td colspan="2"><input type="submit" value="Сохранить" name="yt0" class="button"></td>
			</tr>
		</table>
		<?php $this->endWidget(); ?>
	</div>
