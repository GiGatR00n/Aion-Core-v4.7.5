...
<div class="note">
	<div class="note_title">Add pages</div>
	<div class="note_body">
		...
		<table class="table_info">
			...
			<tr>
				<td colspan="2" align="center">
					<?php echo CHtml::submitButton($model->isNewRecord ? 'Add page' : 'Save changes', array('class'=>'button')); ?>
					<?php if(!$model->isNewRecord):?><input type="button" ONCLICK="location.href='<?php echo Yii::app()->homeUrl; ?>page/delete/<?php echo $model->id; ?>'" class="button" value="Remove page" /><?php endif; ?>
				</td>
			</tr>
		</table>
		<?php $this->endWidget(); ?>
