...
<div class="note">
	<div class="note_title">
		<a href="<?php echo Yii::app()->homeUrl; ?>admin">Admin area</a> &rarr; Bound settings
	</div>
	<div class="note_body">
		...
		<table class="table_info">
			<tr>
				<td class="bold">General settings:</td>
			</tr>
			<tr>
			...
			<tr>
				<td><label for="Settings_hide_top">Hide top players with less access</label></td>
			...
			<tr>
				<td class="bold">Referrals system:</td>
			</tr>
			<tr>
			...
			<tr>
				<td class="bold">Trial privileges:</td>
			</tr>
			<tr>
			...
			<tr class="center">
				<td colspan="2"><input class="button" type="submit" value="Save changes" name="yt0"></td>
			</tr>
		</table>
