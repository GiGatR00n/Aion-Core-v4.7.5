...
<div class="note mb15">
	<div class="note_title">
		<a href="<?php echo Yii::app()->homeUrl; ?>admin">Admin area</a> &rarr; Accounts search
	</div>
	<div class="note_body">
...
<div class="note">
	<div class="note_title">
		<a href="<?php echo Yii::app()->homeUrl; ?>admin">Admin area</a> &rarr; Search results (accounts)
	</div>
	<div class="note_body">
		<?php
