...
<div class="note">
	<div class="note_title">Add a news article</div>
	<div class="note_body">
		...
		<table class="table_info">
			...
			<tr>
				<td colspan="2" align="center">
					<?php echo CHtml::submitButton($model->isNewRecord ? 'Add news' : 'Save changes', array('class'=>'button')); ?>
					<?php if(!$model->isNewRecord):?><input type="button" ONCLICK="location.href='<?php echo Yii::app()->homeUrl; ?>news/delete/<?php echo $model->news_id; ?>'" class="button" value="Remove news" /><?php endif; ?>
				</td>
			</tr>
		</table>
		<?php $this->endWidget(); ?>
