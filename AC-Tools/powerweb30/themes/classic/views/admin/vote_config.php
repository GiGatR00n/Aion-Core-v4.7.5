...
<div class="note">
	<div class="note_title">
		<a href="<?php echo Yii::app()->homeUrl; ?>admin">Admin area</a> &rarr; Vote settings
	</div>
	<div class="note_body">
		...
		<table class="table_info center">
			...
			<tr class="center">
				<td colspan="4"><input class="button" type="submit" value="Save changes" name="yt0"></td>
			</tr>
		</table>
