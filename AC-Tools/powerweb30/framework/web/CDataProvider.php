 ...
 * @property integer $item_count The number of data items in the current page.
...
abstract class CDataProvider extends CComponent implements IDataProvider
{
	 ...
	 * When {@link pagination} is set false, this returns the same value as {@link item_count}.
