...
return array (
  ...
  '&lt; Previous' => '&lt;',
  '&lt;&lt; First' => 'Начало',
  'Action class {class} must implement the "run" method.' => 'Class действия {class} должен содержать метод "run".',
  ...
  '{className} does not support add() functionality.' => 'Class {className} не поддерживает функционал add().',
  '{className} does not support delete() functionality.' => 'Class {className} не поддерживает функционал delete() .',
  '{className} does not support flushValues() functionality.' => '{className} не поддерживает flushValues().',
  '{className} does not support get() functionality.' => 'Class {className} не поддерживает функционал get().',
  '{className} does not support set() functionality.' => 'Class {className} не поддерживает функционал set().',
