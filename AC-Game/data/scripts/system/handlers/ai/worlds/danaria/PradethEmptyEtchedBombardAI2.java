...
@AIName("pradethemptyetchedbombard")
public class PradethEmptyEtchedBombardAI2 extends ActionItemNpcAI2
{
	@Override
	...
	private void startLifeTask() {
		ThreadPoolManager.getInstance().schedule(new Runnable() {
			@Override
			public void run() {
				AI2Actions.deleteOwner(PradethEmptyEtchedBombardAI2.this);
			}
		}, 7200000);
	}
