 ...
 * @author pralinka
 */
public class _13730FonasRequest extends QuestHandler {

	private final static int questId = 13730;

	public _13730FonasRequest() {
		super(questId);
	}

	@Override
	public void register() {
		qe.registerQuestNpc(802331).addOnTalkEvent(questId);
