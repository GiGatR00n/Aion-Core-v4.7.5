    ...
    public void doReward() {
        for (Player player : instance.getPlayersInside()) {
            ...
            if (player.getRace().equals(kamarBattlefieldReward.getWinningRace())) {
                ...
                playerReward.setRewardGp((int) kamarBattlefieldReward.getWinnerPoints());
            } else {
                abyssPoint += kamarBattlefieldReward.getLooserPoints();
                gloryPoint += kamarBattlefieldReward.getLooserPoints();
                playerReward.setRewardAp((int) kamarBattlefieldReward.getLooserPoints());
                playerReward.setRewardGp((int) kamarBattlefieldReward.getLooserPoints());
            }
