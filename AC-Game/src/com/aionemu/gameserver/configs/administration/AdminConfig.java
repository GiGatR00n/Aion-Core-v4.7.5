...
public class AdminConfig {
    ...
    @Property(key = "gameserver.customtag.access7", defaultValue = "\uE0BD \uE042 S-Admin L1 \uE043 %s \uE0BD")
    public static String CUSTOMTAG_ACCESS7;
    @Property(key = "gameserver.customtag.access8", defaultValue = "\uE0BD \uE042 S-Admin L2 \uE043 %s \uE0BD")
    public static String CUSTOMTAG_ACCESS8;
    @Property(key = "gameserver.customtag.access9", defaultValue = "\uE0BD \uE042 Co-Owner \uE043 %s \uE0BD")
