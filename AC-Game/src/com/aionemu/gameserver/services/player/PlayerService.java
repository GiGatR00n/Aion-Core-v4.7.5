...
public class PlayerService {
    ...
    public static Player getPlayer(int playerObjId, Account account) {
        ...
        player.setLoginReward(DAOManager.getDAO(PlayerLoginRewardDAO.class).load(player.getObjectId()));
        ...
        ItemService.loadItemStones(equipment.getEquippedItemsWithoutStigmaOld());
