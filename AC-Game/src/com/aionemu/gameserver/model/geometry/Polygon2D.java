...
public class Polygon2D implements Shape, Cloneable, Serializable {
     ...
     * <code>npoints</code> represents the number of valid points in this
     * <code>Polygon</code>.
     */
    public int npoints;
    /**
     * The array of <i>x</i> coordinates. The value of {@link #npoints npoints}
     * is equal to the number of points in this
     * <code>Polygon2D</code>.
     */
     ...
     * <code>Polygon2D</code> from the specified Rectangle2D.
     *
    ...
    /**
     * Constructs and initializes a
     * <code>Polygon2D</code> from the specified Polygon.
     *
    ...
    /**
     * Constructs and initializes a
     * <code>Polygon2D</code> from the specified parameters.
     *
     ...
     * @throws NegativeArraySizeException if the value * * * * * * * * * * *
     *                                    of <code>npoints</code> is negative.
     * @throws IndexOutOfBoundsException  if <code>npoints</code> is greater
     *                                    than the length of <code>xpoints</code> or the length of
     *                                    <code>ypoints</code>.
     * @throws NullPointerException       if <code>xpoints</code> * * * * * * * *
    ...
    /**
     * Resets this
     * <code>Polygon</code> object to an empty polygon.
     */
    public void reset() {
        npoints = 0;
        bounds = null;
...
class Polyline2D implements Shape, Cloneable, Serializable {
    ...
    /**
     * The total number of points. The value of
     * <code>npoints</code> represents the number of points in this
    ...
    /**
     * Constructs and initializes a
     * <code>Polyline2D</code> from the specified parameters.
     *
     * @param xpoints an array of <i>x</i> coordinates
     * @param ypoints an array of <i>y</i> coordinates
    ...
    /**
     * Resets this
     * <code>Polyline2D</code> object to an empty polygon. The coordinate arrays
     ...
     * <code>Polyline2D</code>. The bounding box is the smallest
     * {@link Rectangle} whose sides are parallel to the x and y axes of the
    ...
    /**
     * Tests if the interior of this
     * <code>Polyline2D</code> entirely contains the specified set of
    ...
    /**
     * Tests if the interior of this
     * <code>Polyline2D</code> entirely contains the specified
     * <code>Rectangle2D</code>. This method is required to implement the Shape
     * interface, but in the case of Line2D objects it always returns false
     * since a line contains no area.
     */
    public boolean contains(Rectangle2D r) {
     ...
     * the
     * <code>Shape</code>. Only SEG_MOVETO and SEG_LINETO, point types are
